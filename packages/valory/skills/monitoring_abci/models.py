...
"""This module contains the shared state for the abci skill of MonitoringAbciApp."""
...
from packages.valory.skills.monitoring_abci.rounds import MonitoringAbciApp
